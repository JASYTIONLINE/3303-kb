---
title: CMPA 3303 Design Glossary
description: Alphabetical glossary of key design process terms from Week 2 readings — integrating the Double Diamond model and Human-Centered Design loop.
tags:
  - cmpa3303
  - design
  - glossary
...
## Define
**Definition:** The second phase of the [[Double Diamond of Design|Double Diamond]] model, where designers analyze gathered information to identify patterns, clarify insights, and frame a clear problem statement.  
...
## Deliver
**Definition:** The final phase of the [[Double Diamond of Design|Double Diamond]], focused on refining, testing, and implementing the chosen solution until it is ready for real-world release.  
**Context:** During Deliver, designers evaluate prototypes through user testing, adjust based on feedback, and finalize the design for launch or presentation.

---

## Develop
**Definition:** The third phase of the [[Double Diamond of Design|Double Diamond]], where designers ideate, experiment, and prototype multiple potential solutions to the defined problem.  
**Context:** In the Develop phase, creative exploration takes center stage—designers brainstorm and test different ideas to see which best meets the user’s needs.

---

## Discover
**Definition:** The first phase of the [[Double Diamond of Design|Double Diamond]] model, focused on open exploration, research, and understanding user needs before attempting to solve anything.  
**Context:** In the Discover phase, designers gather insights through observation and research to uncover what users truly need rather than jumping to conclusions about solutions.
